/* krpano 1.16.7 gyro plugin (build 2013-09-11) 
...
var krpanoplugin = function() {
    ...
    function J(b) {
        if (!G && l) {
            ...
            if (E) {
                ...
                s = m;
            else if (m.yaw != s.yaw || m.pitch != s.pitch || m.roll != s.roll)
                s = null, E=!0, H && (g =- a)
        }
    }
    function w(b) {
    ...
    this.registerplugin = function(b, g, m) {
        ...
        c.version || "2011-03-30" > c.build))
            ...
            e.registerattribute("available", !1, function() {}, function() {
                return k
            });
